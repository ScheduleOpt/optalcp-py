...
class WorkerParameters(TypedDict, total=False):
    ...
    * `Split`: Always split the current range LB..UB in half.
    ...
    lnsMode: Literal['Robust', 'Focused']
    r"""
    ...
    The `Large` :attr:`Parameters.preset` automatically selects `Focused` mode. If you
    explicitly set `lns_mode`, your value takes precedence over the preset.
    ...
    .. code-block:: python
        ...
        result = model.solve({'lnsMode': 'Focused'})
    ...
    .. seealso::
        ...
        - :attr:`Parameters.preset` for automatic configuration based on problem size.
        - :attr:`Parameters.searchType` for choosing the search algorithm.
    """
    ...
    _lnsSkipNoImprovementProbability: float
    _lnsSmallStructureLimit: int
    _lnsResourceOptimization: bool
    _lnsAbsentCoreWeight: float
    _arcWeightAbsentOverride: float
    _arcWeightAlternativeChosen: float
    _arcWeightAlternativeNotChosen: float
    _arcWeightTouchingPOS: float
    _lnsRestoreAbsentIntervals: bool
    _lnsRestoreIntervalLengths: bool
    _lnsRestoreIntVarValues: bool
    _lnsAlwaysRelaxObjective: bool
    ...
    _lnsFDS: bool
    _lnsFragmentFreezing: Literal['Off', 'BeforeOnly', 'On', 'Unsafe']
    ...
    _lnsDisabledHeuristics: int
    _setTimesNbExtendsFactor: float
    _discreteLowCapacityLimit: int
    _presolveCumulRule1: bool
    _presolveCumulRule2: bool
    _presolveCumulRule3: bool
    _presolveCumulRule4MaxDemands: int
...
class Parameters(TypedDict, total=False):
    ...
    **Available presets:**
    ...
    - `Large`: Optimized for big problems with more than 100,000 variables. Uses minimum propagation to reduce overhead, all workers use LNS search, and :attr:`Parameters.lns_mode` is set to `Focused`. This trades propagation strength for scalability.
    ...
    **Parameters affected by presets:**
    ...
    - :attr:`Parameters.lns_mode`: LNS solution pool strategy (`Large` preset selects `Focused`)
    ...
    * `Split`: Always split the current range LB..UB in half.
    ...
    _timeNetSubPriorityBits: int
    _minChainLength: int
    _monitorInterval: float
    _monitorThreshold: float
...
_PARSER_CONFIG: dict[str, _ParserConfigEntry] = {
    ...
    'cumulpropagationlevel': _ParserConfigEntry(
        ...
        parse=_parse_int,  # type: ignore[misc]
        set_globally=lambda p, v, k='cumulPropagationLevel': p.__setitem__(k, _validate_int_range(v, 'CumulPropagationLevel', 0, 4)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='cumulPropagationLevel': w.__setitem__(k, _validate_int_range(v, 'CumulPropagationLevel', 0, 4)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsmode': _ParserConfigEntry(
        name='LNSMode',
        parse=lambda v, n: _parse_enum(v, n, ['Robust', 'Focused']),  # type: ignore[misc]
        set_globally=lambda p, v, k='lnsMode': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='lnsMode': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsinitcumulpropagationlevel': _ParserConfigEntry(
        ...
        parse=_parse_int,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsInitCumulPropagationLevel': p.__setitem__(k, _validate_int_range(v, 'LNSInitCumulPropagationLevel', 0, 4)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsInitCumulPropagationLevel': w.__setitem__(k, _validate_int_range(v, 'LNSInitCumulPropagationLevel', 0, 4)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsskipnoimprovementprobability': _ParserConfigEntry(
        name='LNSSkipNoImprovementProbability',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsSkipNoImprovementProbability': p.__setitem__(k, _validate_float_range(v, 'LNSSkipNoImprovementProbability', 0, 1)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsSkipNoImprovementProbability': w.__setitem__(k, _validate_float_range(v, 'LNSSkipNoImprovementProbability', 0, 1)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsabsentcoreweight': _ParserConfigEntry(
        name='LNSAbsentCoreWeight',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsAbsentCoreWeight': p.__setitem__(k, _validate_float_range(v, 'LNSAbsentCoreWeight', 0, 10)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsAbsentCoreWeight': w.__setitem__(k, _validate_float_range(v, 'LNSAbsentCoreWeight', 0, 10)),  # type: ignore[misc, attr-defined]
    ),
    'arcweightabsentoverride': _ParserConfigEntry(
        name='ArcWeightAbsentOverride',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_arcWeightAbsentOverride': p.__setitem__(k, _validate_float_range(v, 'ArcWeightAbsentOverride', 0, 10)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_arcWeightAbsentOverride': w.__setitem__(k, _validate_float_range(v, 'ArcWeightAbsentOverride', 0, 10)),  # type: ignore[misc, attr-defined]
    ),
    'arcweightalternativechosen': _ParserConfigEntry(
        name='ArcWeightAlternativeChosen',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_arcWeightAlternativeChosen': p.__setitem__(k, _validate_float_range(v, 'ArcWeightAlternativeChosen', 0, 10)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_arcWeightAlternativeChosen': w.__setitem__(k, _validate_float_range(v, 'ArcWeightAlternativeChosen', 0, 10)),  # type: ignore[misc, attr-defined]
    ),
    'arcweightalternativenotchosen': _ParserConfigEntry(
        name='ArcWeightAlternativeNotChosen',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_arcWeightAlternativeNotChosen': p.__setitem__(k, _validate_float_range(v, 'ArcWeightAlternativeNotChosen', 0, 10)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_arcWeightAlternativeNotChosen': w.__setitem__(k, _validate_float_range(v, 'ArcWeightAlternativeNotChosen', 0, 10)),  # type: ignore[misc, attr-defined]
    ),
    'arcweighttouchingpos': _ParserConfigEntry(
        name='ArcWeightTouchingPOS',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_arcWeightTouchingPOS': p.__setitem__(k, _validate_float_range(v, 'ArcWeightTouchingPOS', 0, 100)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_arcWeightTouchingPOS': w.__setitem__(k, _validate_float_range(v, 'ArcWeightTouchingPOS', 0, 100)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsalwaysrelaxobjective': _ParserConfigEntry(
        name='LNSAlwaysRelaxObjective',
        parse=_parse_bool,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsAlwaysRelaxObjective': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsAlwaysRelaxObjective': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsfragmentfreezing': _ParserConfigEntry(
        name='LNSFragmentFreezing',
        parse=lambda v, n: _parse_enum(v, n, ['Off', 'BeforeOnly', 'On', 'Unsafe']),  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsFragmentFreezing': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsFragmentFreezing': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsportionmultiplier': _ParserConfigEntry(
        ...
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsPortionMultiplier': p.__setitem__(k, _validate_float_range(v, 'LNSPortionMultiplier', 0.000001, 10.000000)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsPortionMultiplier': w.__setitem__(k, _validate_float_range(v, 'LNSPortionMultiplier', 0.000001, 10.000000)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'lnsdisabledheuristics': _ParserConfigEntry(
        name='LNSDisabledHeuristics',
        parse=_parse_int,  # type: ignore[misc]
        set_globally=lambda p, v, k='_lnsDisabledHeuristics': p.__setitem__(k, _validate_int_range(v, 'LNSDisabledHeuristics', 0, 4294967295)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_lnsDisabledHeuristics': w.__setitem__(k, _validate_int_range(v, 'LNSDisabledHeuristics', 0, 4294967295)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'presolvecumulrule1': _ParserConfigEntry(
        name='PresolveCumulRule1',
        parse=_parse_bool,  # type: ignore[misc]
        set_globally=lambda p, v, k='_presolveCumulRule1': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_presolveCumulRule1': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    'presolvecumulrule2': _ParserConfigEntry(
        name='PresolveCumulRule2',
        parse=_parse_bool,  # type: ignore[misc]
        set_globally=lambda p, v, k='_presolveCumulRule2': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_presolveCumulRule2': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    'presolvecumulrule3': _ParserConfigEntry(
        name='PresolveCumulRule3',
        parse=_parse_bool,  # type: ignore[misc]
        set_globally=lambda p, v, k='_presolveCumulRule3': p.__setitem__(k, v),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_presolveCumulRule3': w.__setitem__(k, v),  # type: ignore[misc, attr-defined]
    ),
    'presolvecumulrule4maxdemands': _ParserConfigEntry(
        name='PresolveCumulRule4MaxDemands',
        parse=_parse_int,  # type: ignore[misc]
        set_globally=lambda p, v, k='_presolveCumulRule4MaxDemands': p.__setitem__(k, _validate_int_range(v, 'PresolveCumulRule4MaxDemands', 0, 4294967295)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_presolveCumulRule4MaxDemands': w.__setitem__(k, _validate_int_range(v, 'PresolveCumulRule4MaxDemands', 0, 4294967295)),  # type: ignore[misc, attr-defined]
    ),
    ...
    'minchainlength': _ParserConfigEntry(
        name='MinChainLength',
        parse=_parse_int,  # type: ignore[misc]
        set_globally=lambda p, v, k='_minChainLength': p.__setitem__(k, _validate_int_range(v, 'MinChainLength', 0, 4294967295)),  # type: ignore[misc, attr-defined]
        set_on_worker=lambda w, v, k='_minChainLength': w.__setitem__(k, _validate_int_range(v, 'MinChainLength', 0, 4294967295)),  # type: ignore[misc, attr-defined]
    ),
    'monitorinterval': _ParserConfigEntry(
        name='MonitorInterval',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_monitorInterval': p.__setitem__(k, _validate_float_range(v, 'MonitorInterval', 0.000000, float('inf'))),  # type: ignore[misc, attr-defined]
    ),
    'monitorthreshold': _ParserConfigEntry(
        name='MonitorThreshold',
        parse=_parse_float,  # type: ignore[misc]
        set_globally=lambda p, v, k='_monitorThreshold': p.__setitem__(k, _validate_float_range(v, 'MonitorThreshold', 0, 100)),  # type: ignore[misc, attr-defined]
    ),
